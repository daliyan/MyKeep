 ...
 * and return a {@link svgandroid.SVG}.
 * 
 * @since 24/12/2012
 */
public class SVGBuilder {
	 ...
	 */
	public svgandroid.SVG build() throws SVGParseException {
		if (data == null) {
		...
		try {
			...
			final svgandroid.SVG svg = svgandroid.SVGParser.parse(new InputSource(data), handler);
			return svg;
